import {StyleSheet, Text, View, TouchableOpacity, Animated, Image, ActivityIndicator} from 'react-native';
import React, {useState, useRef, useEffect} from 'react';
import {ArrowLeft, Message, Share, More, Like1,Receipt21} from 'iconsax-react-native';
...
const Blogdetail = ({route}) => {
  ...
  const handleDelete = async () => {
   await axios.delete(`https://656b534bdac3630cf727fdbc.mockapi.io/minicar/minicar/${blogId}`)
      .then(() => {
        closeActionSheet()
